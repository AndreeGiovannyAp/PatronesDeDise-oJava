...
public class ModeloEmpleado extends ModeloTabla{
    ...
    public ModeloEmpleado(ArrayList<Articulo> datos2,String tipo) {
        columnNames=new String[]{"Nombre", "Nombre tipo Articulo", "Precio unitario mayorista", "Existencia", "Cantidad","Importe"};
        clases =new Class [] {
    ...
    public void hacerTabla(ArrayList<Articulo> datos2, String tipo) {
        for (int i = 0; i < datos2.size(); i++) {
           ...
           if(a.getTipo().equals(tipo)){
            Object[] aux = {a.getNombreArticulo(),a.getTipo2(), a.getPrecio(),a.getCantidadBodega(), 0, 0};
            datos.add(aux);
            }
        }
    }
